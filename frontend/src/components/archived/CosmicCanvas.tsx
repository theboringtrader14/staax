// CosmicCanvas — archived from Phase A revamp (2026-04-20)
// The STAAX animated background. Re-enable by importing into Layout.tsx
// and rendering <CosmicCanvas /> before <main> with position:fixed, inset:0, zIndex:0
//
// Usage in Layout.tsx:
//   import CosmicCanvas from '@/components/archived/CosmicCanvas'
//   // Then inside the return, before <TopNav>:
//   {showCanvas && <CosmicCanvas />}
//   // where: const showCanvas = location.pathname === '/grid' || location.pathname === '/'
