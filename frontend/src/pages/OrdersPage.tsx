                      ...
                      <table className="staax-table">
                        ...
                        <thead className="order-table-header">
                          <tr>
                            ...
                            <th style={{ textAlign: 'left',   background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>Symbol</th>
                            <th style={{ textAlign: 'center', background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>Lots</th>
                            <th style={{ textAlign: 'center', background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>Fill / Ref</th>
                            <th style={{ textAlign: 'center', background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>LTP</th>
                            <th style={{ textAlign: 'center', background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>SL</th>
                            <th style={{ textAlign: 'center', background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>Target</th>
                            <th style={{ textAlign: 'center', background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>Exit</th>
                            <th style={{ textAlign: 'center', background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>Reason</th>
                            <th style={{ textAlign: 'center', background: 'var(--bg)', color: 'var(--text-mute)', fontSize: 10, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', padding: '8px 20px', verticalAlign: 'middle' }}>P&L</th>
                          </tr>
                        </thead>
                        <tbody>
                          {(w.legs || []).map(leg => (
              ...
              {!isCollapsed && (
                <div style={{ display: 'flex', flexDirection: 'column', marginBottom: '4px' }}>
                  {groupAlgos.map(group => {
                    ...
                    const BTNS = [
                      { label: autoSyncLoading[group.gridEntryId ?? ''] ? '↻' : 'SYNC', col: '#CC4400', bg: 'rgba(204,68,0,0.05)', hBg: 'rgba(204,68,0,0.14)', border: undefined, disabled: isPractixMode || (!hasOpenLegs && !someLegsError) || !!autoSyncLoading[group.gridEntryId ?? ''], title: isPractixMode ? 'SYNC unavailable in PRACTIX mode' : 'Auto-sync unlinked orders from broker', action: () => doAutoSync(gi, group.gridEntryId) },
