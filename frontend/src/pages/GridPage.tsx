                        ...
                        <div key={algo.id}
                          ...
                          <div className="algo-card" style={{ display:'flex', alignItems:'stretch', minHeight:'88px' }}>
                            ...
                            <div style={{ flex:1, display:'flex', alignItems:'center', gap:'16px', padding:'16px 20px' }}>
                              ...
                              <div style={{ display:'flex', alignItems:'center', gap:6, width:'90px', flexShrink:0, justifyContent:'center', marginLeft:'18px' }}
                              ...
                              <div className="algo-card-days" style={{ display:'flex', gap:'4px', alignItems:'center', flexShrink:0, justifyContent:'center', marginLeft:'18px' }}>
                                {ALL_DAYS.map((day, i) => {
