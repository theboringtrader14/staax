...
# ── API routers ────────────────────────────────────────────────────────────────
from app.api.v1 import auth, accounts, algos, grid, orders, services, system, reports, events, bots, holidays as holidays_api, logs as logs_api, ai as ai_api, mobile as mobile_api, analytics as analytics_api, whatsapp as whatsapp_api
...
async def lifespan(app: FastAPI):
    ...
    # ── 12b. Restore SL/TP monitoring for open positions (fills PositionRebuilder gap) ─
